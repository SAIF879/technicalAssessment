...
import com.example.technicalassessment.databinding.LinkCardBinding
import com.example.technicalassessment.screens.home.model.RvLinkModalClass

class HomeScreenLinkAdapter(private var items : List<RvLinkModalClass>) : RecyclerView.Adapter<HomeScreenLinkAdapter.HomeViewHolder>()
{
